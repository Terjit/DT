...
class planVsActual(QMainWindow):
    ...
    def pullData(self):
        ...
        self.wellA = pd.read_sql_query(f"SELECT * FROM DEV WHERE wellName = '{self.well}' AND Planned = 0 AND Lateral = 'NULL'", conn)
    ...
    def section(self):
        ...
        self.axs.plot(self.wellDf['NS'], self.wellDf['TVD'], color='black', label = 'Planned')
    ...
    def tvdMd(self):
        ...
        self.ax2.plot(self.wellDf['MD'], self.wellDf['TVD'], color = 'black', label = 'Planned')
    ...
    def plan(self):
        ...
        self.axp.plot(self.wellDf['EW'], self.wellDf['NS'], color = 'black', label = 'Actual')
    ...
    def threed(self):
        ...
        self.ax3d.plot3D(self.wellDf['EW'], self.wellDf['NS'],self.wellDf['TVD'], color = 'black', label = 'Planned')
