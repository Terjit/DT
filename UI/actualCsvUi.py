...
################################################################################
## Form generated from reading UI file 'actualCsv.ui'
##
...
class Ui_importCsvWindow(object):
    ...
    def retranslateUi(self, importCsvWindow, well):
        ...
        self.label.setText(QCoreApplication.translate("importCsvWindow", f"<html><head/><body><p>Update actual deviation information {well}. </p><p>Please import a .CSV</p></body></html>", None))
